...
import { createPromoCode } from "@/lib/dal";
      ...
      <div className="space-y-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold tracking-tight text-zinc-900">New promo code</h1>
              <p className="text-sm text-zinc-600">Create a discount code for your customers.</p>
            </div>
          </div>
          <Button
            type="button"
