    ...
    <div className="min-h-screen flex bg-zinc-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-zinc-900 overflow-hidden">
        <div
          ...
          style={{ backgroundImage: "url(https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?w=800&q=80)" }}
        />
        <div className="relative z-10 flex flex-col justify-end p-8 pb-12">
          ...
          <h2 className="mt-6 text-3xl font-bold text-white">Join 5,000+ Healthcare Leaders</h2>
          <p className="mt-2 text-gold">— Elevating healthcare quality standards worldwide.</p>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center px-4 py-8">
          <div className="w-full max-w-md">
            ...
            <p className="mt-1 text-zinc-600">Start your journey toward CPHQ certification today.</p>
            ...
            <form className="mt-8 space-y-5" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="space-y-2">
                <Label className="text-sm font-medium text-zinc-700">Healthcare Specialty</Label>
                <div className="relative">
            ...
            <div className="mt-6 flex items-center gap-4">
              ...
              <span className="text-xs font-medium uppercase text-zinc-400">Or join with</span>
              <div className="h-px flex-1 bg-zinc-200" />
            </div>
            <div className="mt-6 grid grid-cols-2 gap-3">
              <Button type="button" variant="outline" className="h-11 rounded-lg border-zinc-200 gap-2">
