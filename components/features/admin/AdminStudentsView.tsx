...
import { createUser, fetchUsers, removeUser, updateUser } from "@/lib/dal";
...
export function AdminStudentsView() {
  ...
  const [enrollment, setEnrollment] = React.useState<EnrollmentFilter>("all");
  ...
  }, [students, query, role, enrollment]);
  ...
  return (
    <div className="space-y-6">
      <Card className="rounded-2xl border-zinc-200 bg-white shadow-sm">
        <CardHeader className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between space-y-0">
          <div>
            ...
            <CardDescription>Manage students, roles, and access.</CardDescription>
          </div>
        ...
        <CardContent className="pt-0 space-y-4">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Select value={enrollment} onValueChange={(v) => setEnrollment(v as EnrollmentFilter)}>
      ...
      <ConfirmDialog
        ...
        description={deleting ? `This will permanently remove ${deleting.email}.` : "This will permanently remove the student."}
        confirmText="Delete"
